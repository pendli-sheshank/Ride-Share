...
dependencies {
  ...
  // Google sign-in: Credential Manager asks Google for an ID token, which :shared then trades for
  // a Firebase session over REST. No Firebase SDK is involved on either side of that.
